...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Aug 28 21:14:45 2012
...
SOURCES       = src/mainwindowimpl.cpp \
		...
		test/test.cpp \
		log/log_impl.cpp \
		mainwin/tables/summarytable.cpp build/moc_mainwindowimpl.cpp \
...
compiler_moc_header_make_all: build/moc_mainwindowimpl.cpp build/moc_kernel.cpp build/moc_settings.cpp build/moc_login.cpp build/moc_registration.cpp build/moc_add_item.cpp build/moc_load_item.cpp build/moc_unload_item.cpp build/moc_remove_item.cpp build/moc_c_summary.cpp build/moc_ma_log.cpp build/moc_c_logact.cpp build/moc_test.cpp build/moc_log_impl.cpp build/moc_summarytable.cpp
